...
2. **Duplicate Schema Files**
   ...
   - `/docs/spec/phase1/contracts/*.schema.json`
   - Fix: Consolidate to single location, remove duplicates

3. **Scaffold Fails on Existing Files** (`tools/scaffold.py:284`)
...
5. **Missing items_row.schema.json in Required Contracts** (`tools/compile.py:373`)
